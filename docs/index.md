...
!!! warning "현재 일정은 잠정안입니다"
    항공편 외 일정과 숙박 배치는 예약 전까지 조정될 수 있습니다. 운영시간·휴관일·교통편은 예약 전과 출발 직전에 공식 출처에서 다시 확인합니다.

## 한눈에 보는 여정

| 구간 | 숙박 | 핵심 계획 |
|---|---:|---|
| 12/23–12/24 테르미니 | 1박 | 공항철도로 이동·숙박, 다음 날 나폴리 고속열차 |
...
- 로마를 마지막 5박으로 묶어 판테온, 치비타·오르비에토, 바티칸을 평일에 배치합니다.
...
<div class="action-grid">
  <div class="action-card">
    <h3>세 구간 숙소</h3>
    <p>테르미니 1박, 나폴리 4박, 로마 5박의 후보 지역과 체크인·짐 보관 조건을 비교합니다.</p>
  </div>
  <div class="action-card">
    <h3>12월 25일 렌터카</h3>
    <p>Locauto 나폴리 중앙역점 당일 수령·반납을 우선하고 성탄절 실제 영업시간과 시간 외 반납 절차를 확인합니다.</p>
  </div>
  <div class="action-card">
    <h3>성탄절 아말피 점심</h3>
    <p>아말피에서 실제 영업하는 가족 식당을 예약하고 포지타노·라벨로 체류시간을 조절합니다.</p>
  </div>
  <div class="action-card">
    <h3>겨울 교통</h3>
...
1. 취소 가능한 조건으로 테르미니 1박·나폴리 4박·로마 5박 숙소 비교
