...
항공편 외에는 현재 잠정안입니다. 상태 배지는 일정 성격을 나타내며, **예약 필요**가 함께 표시된 날은 [예약 현황](reservations.md)에서도 관리합니다.

[주요 관광지를 지도에서 보기](map.md){ .md-button }

<div class="day-card">
  <h3>12월 23일 수요일 · 로마 도착</h3>
  <p class="day-card__meta">1일차 · 로마 1/4박</p>
  <span class="status confirmed">확정</span>
  <ul>
    <li>인천 14:05 출발 → 로마 FCO 19:35 도착</li>
    <li>입국·수하물 수령 후 숙소 이동</li>
    <li>늦은 체크인이 가능한 숙소 필요</li>
  </ul>
</div>
...
<div class="day-card">
  ...
  <ul>
    ...
    <li>정오 이후: 성베드로 대성당과 광장</li>
    <li>14:00 이후 늦은 점심과 휴식</li>
  </ul>
  <details class="day-details">
    ...
    <ul>
      ...
      <li>11:30~12:00 퇴장·광장 이동</li>
      <li>12:00 이후 보안검색 → 12:30~14:00 대성당·광장</li>
    </ul>
    <h4>확인한 내용</h4>
    <ul>
      <li>성탄 전야 단축 운영: 08:00 개관 · 13:00 마지막 입장 · 15:00 폐관</li>
      <li>08:00 매진 시 08:30 → 09:00 순으로 확인</li>
      <li>시스티나 성당은 박물관 입장권에 포함</li>
      <li>가족 온라인 티켓 예상액은 현재 가격 기준 €80, 예약 시 재확인</li>
      <li>대성당 일반 입장은 무료이며 별도 보안검색 필수</li>
    </ul>
    <p><strong>재확인:</strong> 대성당 일정은 2026년 성탄 전례와 보안 통제 발표 후 확정합니다.</p>
    <p><a href="https://github.com/Jaeho211/italy-family-trip-2026/blob/main/research/vatican-2026-12-24.md" target="_blank" rel="noopener">상세 조사와 공식 출처 보기</a></p>
  </details>
</div>
...
<div class="day-card">
  <h3>12월 30일 수요일 · 아말피 해안</h3>
  <p class="day-card__meta">8일차 · 나폴리 4/4박</p>
  ...
  <ul>
    <li>포지타노를 핵심으로, 아말피는 점심·두오모 중심</li>
    <li>라벨로는 날씨·주차·남은 시간이 모두 충분할 때만 추가</li>
    <li>일몰 전에 어려운 해안도로 구간을 마치고 초행길 야간운전 최소화</li>
    <li>강한 비·안개·바람이면 렌터카를 취소하고 나폴리 또는 카세르타로 전환</li>
  </ul>
  <details class="day-details">
    <summary>검증할 내용 더보기</summary>
    <ul>
      <li>포지타노·아말피 기본안이 겨울 일조시간 안에 성립하는지 시간표 계산</li>
      <li>렌터카 지점의 수령·반납시간, 자동변속 보장, 보험·무료취소 조건</li>
      <li>SS163 도로 통제·공사·낙석 공지와 강수·안개·바람에 따른 중단 기준</li>
      <li>세 도시의 겨울 주차장 운영·예약·요금과 중심지까지의 경사·도보거리</li>
      <li>아말피 두오모·Villa Rufolo의 겨울 운영과 마지막 입장시간</li>
      <li>카세르타 궁전과 기차 이동을 포함한 악천후 대체안의 12월 30일 운영</li>
    </ul>
    <p><strong>판정 원칙:</strong> 세 도시 완주보다 일몰 전 안전한 해안도로 이동을 우선합니다. 출발 48시간 전 1차 판단, 전날 저녁 최종 결정.</p>
  </details>
</div>
...
<div class="day-card">
  <h3>1월 1일 금요일 · 로마 완충일</h3>
  <p class="day-card__meta">10일차 · 로마 2/2박</p>
  <span class="status tentative">잠정</span>
  <ul>
    <li>늦은 오전 시작</li>
    <li>산책, 공원, 쇼핑 또는 휴식</li>
    <li>신정 휴관을 고려해 예약 관광지는 최소화</li>
    <li>전날 일정과 누적 피로를 흡수</li>
  </ul>
</div>
...
<div class="day-card">
  <h3>1월 3일 일요일 · 인천 도착</h3>
  <p class="day-card__meta">12일차</p>
  <span class="status confirmed">확정</span>
  <ul><li>인천 17:25 도착</li></ul>
</div>
