...
공개 문서에는 숙소 후보 **지역**과 일반적인 예약 상태만 기록합니다. 민감한 예약 세부정보는 별도의 비공개 수단으로 관리하세요.

## 구조와 구현 결정

```text
docs/                       여행 콘텐츠
  assets/stylesheets/       모바일·상태 배지 스타일
.github/workflows/pages.yml GitHub Pages 배포
mkdocs.yml                  사이트·메뉴 설정
