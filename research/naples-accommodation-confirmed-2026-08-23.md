# 나폴리 4박 숙소 확정 · 2026년 8월 23일

## 결론

- 2026년 12월 24일부터 28일까지 나폴리 숙소는 **Una terrazza a Chiaia**로 예약 완료했다.
- 주소는 **Via Santa Teresa a Chiaia 39, 80121 Napoli**로 기록한다.
- 정확한 주소 공개는 여행 중 길찾기 편의를 위한 사용자의 명시적 요청이며, 캄파니아주 공개 숙박시설 등록부에서도 숙소명과 주소를 확인했다.
- 예약번호·가격·결제정보·객실정보·출입정보는 공개 저장소에 기록하지 않는다.

## 공개 리스팅에서 확인한 정보

- 숙소 유형: 콘도미니엄 전체
- 가족 구성: 최대 5명, 침실 1개와 거실의 추가 취침 공간
- 편의시설: 엘리베이터, 복사열 난방, 세탁기·건조기, 주방, Wi-Fi
- 공개 권역: Piazza dei Martiri, Via Chiaia와 해안 산책로 인근
- 체크인: 15:00 이후

출처: [Airbnb 공개 리스팅](https://www.airbnb.co.kr/rooms/52820126)

주소 확인: [캄파니아주 공개 숙박시설 등록부](https://www.regione.campania.it/assets/documents/elenco-delle-strutture-ricettive-della-campania-terzo-trimestre-2025.pdf)

지도 표시 좌표는 [Google Maps 주소 검색](https://www.google.com/maps/search/?api=1&query=Via+Santa+Teresa+a+Chiaia+39+Napoli)에서 확인한 주소 지점을 사용한다. 좌표는 표시용이며 건물 입구와 택시 하차 지점은 도착 전에 다시 확인한다.

## 일정 반영

- 12월 24일 Napoli Centrale 도착 후 짐을 들고 숙소까지 이동할 때는 택시를 우선한다.
- 공개 리스팅의 일반 체크인 시간인 15:00 이후에 맞춰 도착한다. 13:00 이른 체크인을 전제로 하지 않는다.
...
- **미확인:** The RomeHello의 12월 24일 체크아웃 후 짐 보관과 2026년 12월 25~27일 Linea 2 실제 운행 시각은 각각 숙소와 Trenitalia에서 재확인한다.

숙소 정보 확인일: 2026-08-23 · 일정 갱신일: 2026-09-13 · 재확인: 2026년 12월 중순
